		...
		<div class="team-members clearfix">
			...
			<div class="member">
				<div class="member-text">
					<div class="member-img set-bg" data-setbg="/assets/img/member/1.jpg"></div>
					<h2>Tom Binegar</h2>
				...
				<div class="member-info">
					<div class="member-img mf set-bg" data-setbg="/assets/img/member/1.jpg"></div>
			...
			<div class="member">
				<div class="member-text">
					<div class="member-img set-bg" data-setbg="/assets/img/member/2.jpg"></div>
					<h2>Jackson Nash</h2>
					<span>Business Development</span>
				</div>
				<div class="member-social">
				...
				<div class="member-info">
					<div class="member-img mf set-bg" data-setbg="/assets/img/member/2.jpg"></div>
					<div class="member-meta">
						<h2>Jackson Nash</h2>
						<span>Marketing Director</span>
					</div>
			...
			<div class="member">
				<div class="member-text">
					<div class="member-img set-bg" data-setbg="/assets/img/member/3.jpg"></div>
					<h2>Tom Binegar</h2>
					<span>Business Development</span>
				</div>
				<div class="member-social">
				...
				<div class="member-info">
					<div class="member-img mf set-bg" data-setbg="/assets/img/member/3.jpg"></div>
					<div class="member-meta">
			...
			<div class="member">
				<div class="member-text">
					<div class="member-img set-bg" data-setbg="/assets/img/member/4.jpg"></div>
					<h2>Melissa Barth</h2>
				...
				<div class="member-info">
					<div class="member-img mf set-bg" data-setbg="/assets/img/member/4.jpg"></div>
					<div class="member-meta">
						<h2>Melissa Barth</h2>
						<span>Product Manager</span>
					</div>
			...
			<div class="member">
				<div class="member-text">
					<div class="member-img set-bg" data-setbg="/assets/img/member/5.jpg"></div>
					<h2>Katy Abrams</h2>
				...
				<div class="member-info">
					<div class="member-img mf set-bg" data-setbg="/assets/img/member/5.jpg"></div>
					<div class="member-meta">
						<h2>Katy Abrams</h2>
						<span>Head of Design</span>
					</div>
